...
('Fernanda "Fer" Martinez', ARRAY['Microblading', 'Permanent Makeup', 'Eyebrow Design'], '+52 55 1234 5678', 'fer.martinez@maxfra.mx'),
('Maggy Hernandez', ARRAY['Volume Lashes', 'Classic Lashes', 'Lash Lifting'], '+52 55 2345 6789', 'maggy.hernandez@maxfra.mx'),
('Paola "Pao" Rodriguez', ARRAY['Henna Brows', 'Eyebrow Lamination', 'Tinting'], '+52 55 3456 7890', 'pao.rodriguez@maxfra.mx'),
('Rosario "Rosi" Gutierrez', ARRAY['Advanced Microblading', 'Ombre Brows', 'Training'], '+52 55 4567 8901', 'rosi.gutierrez@maxfra.mx'),
...
('Roma Norte', 'Av. Álvaro Obregón 123, Roma Nte., Cuauhtémoc, 06700 Ciudad de México, CDMX', '+52 55 1111 2222', (SELECT id FROM instructors WHERE name = 'Sofia Mendez')),
('Pedregal', 'Periférico Sur 789, Jardines del Pedregal, Álvaro Obregón, 01900 Ciudad de México, CDMX', '+52 55 5555 6666', (SELECT id FROM instructors WHERE name = 'Diana Herrera'));
...
-- Insert appointments for today and upcoming days
...
((SELECT id FROM students WHERE full_name = 'Emma Rodriguez Sanchez'), (SELECT id FROM instructors WHERE name LIKE 'Fernanda%'), (SELECT id FROM services WHERE name = 'Microblading Certification'), (SELECT id FROM locations WHERE name = 'Polanco'), '2025-06-24', '10:00', '13:00', 'confirmed', 'Final practical session'),
((SELECT id FROM students WHERE full_name = 'Ana Gutierrez Morales'), (SELECT id FROM instructors WHERE name = 'Maggy Hernandez'), (SELECT id FROM services WHERE name = 'Volume Lashes Course'), (SELECT id FROM locations WHERE name = 'Polanco'), '2025-06-24', '10:00', '13:00', 'confirmed', 'Advanced volume techniques'),

-- Tomorrow's appointments (June 25, 2025)
((SELECT id FROM students WHERE full_name = 'Isabella Chen Wang'), (SELECT id FROM instructors WHERE name LIKE 'Paola%'), (SELECT id FROM services WHERE name = 'Henna Specialist Certification'), (SELECT id FROM locations WHERE name = 'Roma Norte'), '2025-06-25', '09:00', '12:00', 'confirmed', 'Henna application practice'),
((SELECT id FROM students WHERE full_name = 'Sophia Kim Lee'), (SELECT id FROM instructors WHERE name = 'Maggy Hernandez'), (SELECT id FROM services WHERE name = 'Volume Lashes Course'), (SELECT id FROM locations WHERE name = 'Pedregal'), '2025-06-25', '14:00', '17:00', 'pending', 'Volume lash assessment'),

-- Day after tomorrow (June 26, 2025)
((SELECT id FROM students WHERE full_name = 'Carmen Flores Ruiz'), (SELECT id FROM instructors WHERE name LIKE 'Fernanda%'), (SELECT id FROM services WHERE name = 'Classic Lashes Course'), (SELECT id FROM locations WHERE name = 'Polanco'), '2025-06-26', '10:00', '13:00', 'confirmed', 'Classic lash certification exam'),
((SELECT id FROM students WHERE full_name = 'Lucia Mendoza Torres'), (SELECT id FROM instructors WHERE name LIKE 'Rosario%'), (SELECT id FROM services WHERE name = 'Permanent Makeup Course'), (SELECT id FROM locations WHERE name = 'Roma Norte'), '2025-06-26', '15:00', '19:00', 'confirmed', 'Permanent makeup final project'),

-- Future appointments
((SELECT id FROM students WHERE full_name = 'Valentina Castro Jimenez'), (SELECT id FROM instructors WHERE name LIKE 'Rosario%'), (SELECT id FROM services WHERE name = 'Ombre Brows Technique'), (SELECT id FROM locations WHERE name = 'Pedregal'), '2025-06-27', '11:00', '13:30', 'pending', 'Ombre technique workshop'),
((SELECT id FROM students WHERE full_name = 'Emma Rodriguez Sanchez'), (SELECT id FROM instructors WHERE name LIKE 'Fernanda%'), (SELECT id FROM services WHERE name = 'Microblading Touch-up'), (SELECT id FROM locations WHERE name = 'Polanco'), '2025-06-30', '14:00', '15:00', 'pending', 'Post-course touch-up session');
